...
@SpringBootTest
public class StadiumParkingTypeIT {
    ...
    private ParkingPlace parkingPlace = ParkingPlace.builder()
            .parkingPlaceType(ParkingPlaceType.STADIUM)
            .feePolicyType(FeePolicyType.STADIUM)
    ...
    void shouldUnParkVehicle() {
        ...
        // update in time
        var localDateTime = LocalDateTime.now().minusMinutes(200L).toString();
        ...
        // Scooter charge for 200 min is
        assertThat(receiptDtoResponseEntity.getBody().getFees()).isEqualTo(BigDecimal.valueOf(30L));
    }
